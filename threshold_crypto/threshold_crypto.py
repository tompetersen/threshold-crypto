...
class ThresholdParameters:
    ...
    def __init__(self, t: int, n: int):
        ...
        """
        if t > n:
            raise ThresholdCryptoError('threshold parameter t must be less or equal to n')
        if t < floor(n/2) + 1:
            raise ThresholdCryptoError('threshold parameter t must be greater than n/2 +1')
...
class ThresholdCrypto:
    ...
    @staticmethod
    def static_manual_key_parameters():
        p = 23
        q = 11
        g = 6
        # zq = [1, 2, 3, 4, 6, 8, 9, 12, 13, 16, 18]
    ...
    @staticmethod
    def initialize_participants(key_params: KeyParameters, threshold_params: ThresholdParameters) -> [Participant]:
        """
        Pedersen91-related
    ...
    @staticmethod
    def create_public_key(participants: List[Participant], key_params: KeyParameters) -> PublicKey:
        """
        Pedersen91-related
